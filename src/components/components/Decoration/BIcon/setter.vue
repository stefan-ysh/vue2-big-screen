...
<template>
  <el-form label-width="80px" size="mini">
    <el-form-item label="图标">
      ...
      >
        <div slot="prefix">
          <i :class="attribute.iconType" />
        </div>
        <el-option v-for="item in iconTypes" :key="item.value" :value="item.value">
          <i :class="item.value" />
        </el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="图标颜色">
      <BColorPicker :data="attribute" field="color" show-alpha />
    </el-form-item>
    <el-form-item label="图标背景色">
      <BColorPicker :data="attribute" field="background" show-alpha />
    </el-form-item>
    <el-form-item label="图标大小">
      <el-input-number v-model="attribute.iconSize" :min="15" style="width: 100%" controls-position="right" />
    </el-form-item>
  </el-form>
</template>
