...
<template>
  <div>
    <el-form label-width="100px" size="mini">
      ...
      <el-form-item label="坐标数值">
        <el-switch v-model="attribute.axisLabelVisible" />
      </el-form-item>
      <el-form-item label="指示器文字">
        <el-switch v-model="attribute.axisNameVisible" />
      </el-form-item>
      <el-form-item label="静态指示器">
        <el-switch v-model="attribute.staticIndicator" />
      </el-form-item>
      <el-form-item v-show="attribute.staticIndicator" label="指示器内容">
        <el-input v-model="attribute.indicator" type="textarea" />
      </el-form-item>
      <el-form-item v-show="attribute.axisNameVisible" label="指示器文字大小">
        <el-input-number v-model="attribute.axisNameFontSize" style="width: 100%" controls-position="right" />
      </el-form-item>
      <el-form-item v-show="attribute.axisNameVisible" label="指示器文字颜色">
        <BColorPicker :data="attribute" field="axisNameColor" />
      </el-form-item>
      <el-form-item v-show="attribute.axisNameVisible" label="名称轴距">
      ...
      <el-form-item label="射线颜色">
        <BColorPicker :data="attribute" field="axisLineColor" />
      </el-form-item>
      <el-form-item label="网格颜色">
        <BColorPicker :data="attribute" field="splitLineColor" />
      </el-form-item>
      <el-form-item label="网格背景色">
        <BColorPicker :data="attribute" field="splitAreaColor" />
      </el-form-item>
