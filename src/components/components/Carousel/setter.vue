  ...
  <div>
    <el-form label-width="80px" size="mini">
      <el-form-item label="自动切换">
        <el-switch v-model="attribute.autoplay" size="mini" style="width:100%" />
      </el-form-item>
      ...
      <el-form-item label="切换方向">
        <el-select v-model="attribute.direction" style="width:100%" size="mini" placeholder="请选择切换方向">
          <el-option label="横向" value="horizontal" />
          <el-option label="纵向" value="vertical" />
        </el-select>
      </el-form-item>
      <el-form-item label="切换箭头">
        <el-select v-model="attribute.arrow" style="width:100%" size="mini" placeholder="请选择切换箭头显示时机">
      ...
      <el-form-item label="切换触发">
        <el-select v-model="attribute.trigger" style="width:100%" size="mini" placeholder="请选择触发切换方式">
          <el-option label="鼠标悬停触发" value="hover" />
          <el-option label="鼠标点击触发" value="click" />
        </el-select>
      </el-form-item>
      <el-form-item label="轮播风格">
        <el-select v-model="attribute.carouseltype" style="width:100%" size="mini" placeholder="请选择触发切换方式">
          <el-option label="默认" value="default" />
          <el-option label="卡片" value="card" />
        </el-select>
      </el-form-item>
      <el-form-item label="图片填充">
        <el-select v-model="attribute.fit" style="width:100%" size="mini" placeholder="请选择图片填充方式">
...
export default {
  ...
  methods: {
    ...
    handleError (err, file) {
      console.log('%c [ err ]-126', 'font-size:13px; background:pink; color:#bf2c9f;', err)
