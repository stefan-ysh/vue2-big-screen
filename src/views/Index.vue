    ...
    <el-table :data="bigscreenList" border style="width: 90%">
      ...
      <el-table-column prop="prop" label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="editBigscreen(scope.row.id)" plain icon="el-icon-edit-outline" type="primary"
            >编辑</el-button
          >
          <el-button
            size="mini"
          ...
          >
            ...
            发布</el-button
          >
          <el-button size="mini" @click="delBigscreen(scope.row.id)" icon="el-icon-delete" type="danger"
            >删除</el-button
          >
        </template>
      </el-table-column>
